...
#  Jul 10, 2021 01:25:01 PM CAT  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top44 {base} {
    ...
    label $top.lab49 \
        ...
        -highlightcolor black -text {Choose your Favorite Style} 
    vTcl:DefineAlias "$top.lab49" "Label3" vTcl:WidgetProc "Toplevel1" 1
    ttk::combobox $top.tCo46 \
        -values 1 -justify center -textvariable combobox -foreground {} \
        -background {} -takefocus {} 
    vTcl:DefineAlias "$top.tCo46" "TCombobox1" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab50 \
        -activebackground #f9f9f9 -activeforeground black -background #ffffff \
        -disabledforeground #a3a3a3 \
        -font {-family {Segoe UI Symbol} -size 12 -weight bold -slant roman -underline 0 -overstrike 0} \
        -foreground #5f5f5f -highlightbackground $vTcl(actual_gui_bg) \
        -highlightcolor black -text Style 
    ...
    place $top.tCo46 \
        -in $top -x 0 -relx 0.501 -y 0 -rely 0.547 -width 0 -relwidth 0.175 \
        -height 0 -relheight 0.04 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 0 -relx 0.367 -y 0 -rely 0.536 -width 0 -relwidth 0.101 \
        -height 0 -relheight 0.058 -anchor nw -bordermode ignore 
    place $top.but45 \
        -in $top -x 0 -relx 0.44 -y 0 -rely 0.698 -width 117 -relwidth 0 \
        -height 34 -relheight 0 -anchor nw -bordermode ignore 
